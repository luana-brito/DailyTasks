...
type LoginScreenProps = {
  ...
  onSolicitarCadastro?: () => void
  carregando?: boolean
  erro?: string | null
}

export function LoginScreen({ onSubmit, onRecuperarSenha, onSolicitarCadastro, carregando = false, erro = null }: LoginScreenProps) {
  useThemeInit()
  ...
  const handleRecuperarSenha = async (event: FormEvent<HTMLFormElement>) => {
    event.preventDefault()
